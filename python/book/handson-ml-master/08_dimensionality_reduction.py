...
get_ipython().magic('timeit -n 50 KMeans(algorithm="elkan").fit(X)')


# In[43]:


get_ipython().magic('timeit -n 50 KMeans(algorithm="full").fit(X)')
...
get_ipython().magic('timeit KMeans(n_clusters=5).fit(X)')


# In[54]:


get_ipython().magic('timeit MiniBatchKMeans(n_clusters=5).fit(X)')
